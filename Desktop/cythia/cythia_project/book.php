...
<body style="background-image:url(images/doc2.jpg)">
	<div class="header">
		<ul>
	...
	<div class="sucontainer" style="background-image:url(images/doc1.gif)">
...
if(isset($_POST['submit']))
{
		...
		$sql = "INSERT INTO book (Fname,Gender,CID,DID,DOV,Timestamp,Status) VALUES ('$fname','$gender','$cid','$did','$dov','$timestamp','$status') ";
